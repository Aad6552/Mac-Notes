...
- **OneDrive** / **Google Drive** / **Dropbox** — click Connect, your
  browser opens straight to the provider's own login page. Nothing passes
  through the app; it just picks up the resulting token once you approve
  access.
